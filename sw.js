...
const urlsToCache = [
  ...
  '/yanisnails/utils/push-config.js',
  '/yanisnails/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/yanisnails/icons/icon-192x192.png',
    badge: '/yanisnails/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/yanisnails/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/yanisnails/admin.html';
  event.waitUntil(
